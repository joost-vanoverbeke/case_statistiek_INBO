...
- Meer duiding van de vraagstelling: specifieer 'het beste'
  + grootste **precisie** in metingen? (kleinste verschillen tussen replicate metingen)
  + kleinste **afwijking** in metingen van de 'ware' concetratie? (consequent te hoge of te lage gemeten concentraties)
